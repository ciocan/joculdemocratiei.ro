...
// Countdown time for the next round in milliseconds (5 seconds)
export const NEXT_ROUND_COUNTDOWN_TIME = 5_000;

// Countdown update interval in milliseconds for smooth UI updates
export const COUNTDOWN_UPDATE_INTERVAL = 60;

// Number of messages to display for each candidate
export const CANDIDATE_MESSAGES_COUNT = 4;
