/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5c916ebcc1cda7bd3636f77791a63ec7)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "JWT_SECRET" | "LOCAL_DB_PATH" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "DB_ID">> {}
}
declare module "*.sql" {
	const value: string;
