/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b2de0e70962a707953da69c90aa8b557)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "LOCAL_DB_PATH" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "DB_ID" | "ENVIRONMENT" | "DEBUG">> {}
}
declare module "*.sql" {
	const value: string;
