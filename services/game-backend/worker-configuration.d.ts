/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6a299b47dca0dbebe348dd77a3fea59)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "LOCAL_DB_PATH" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "DB_ID" | "ENVIRONMENT">> {}
}
declare module "*.sql" {
	const value: string;
